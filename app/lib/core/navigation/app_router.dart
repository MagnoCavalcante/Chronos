...
class AppRouter {
  ...
  static Map<String, WidgetBuilder> get routes => {
        ...
        RouteNames.civilizations: (context) => const _FutureSprintPlaceholderScreen(
              title: 'Civilizações Antigas',
              description: 'O mapeamento de impérios, linhagens dinásticas e evolução sociocultural será disponibilizado na Sprint 5.2.',
